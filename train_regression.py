...
from tbnn.pdmp.model import (plot_density, get_model_state, pred_forward_pass,
                             ...
                             build_network,
                             bps_main, pbps_main, hmc_main, nuts_main, boomerang_main,
...
def main(args):
  ...
  if args.boomerang:
    boomerang_main(model, args.ipp_sampler, args.likelihood, args.ref, args.num_results,
                   args.num_burnin, args.out_dir,
                   bnn_neg_joint_log_prob, likelihood_fn, map_initial_state,
                   X_train, y_train, X_test, y_test, data_size, data_size, data_dimension_dict,
                   plot_results=~args.no_plot)
  if args.pbps:
     pbps_main(model, args.ipp_sampler, args.likelihood, args.ref, args.num_results,
             args.num_burnin, args.out_dir,
             bnn_neg_joint_log_prob, map_initial_state,
             X_train, y_train, X_test, y_test, data_size, data_size, data_dimension_dict,
             plot_results=~args.no_plot)
